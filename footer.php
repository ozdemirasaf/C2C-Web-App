                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        ...
                        <ul class="footer-social">
                            <li><a href="<?php echo "https://" . $ayarcek['ayar_facebook'] ?>"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="<?php echo "https://" . $ayarcek['ayar_twitter'] ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="<?php echo "https://" . $ayarcek['ayar_youtube'] ?>"><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>
                            <li><a href="<?php echo "https://" . $ayarcek['ayar_google'] ?>"><i class="fa fa-google" aria-hidden="true"></i></a></li>
