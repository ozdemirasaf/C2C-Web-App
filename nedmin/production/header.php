          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="magazalar.php"><i class="fa fa-shopping-basket"></i> Mağzalar</a></li>

                <li><a href="magaza-basvuru.php"><i class="fa fa-shopping-basket"></i> Mağza Başvurusu </a></li>
