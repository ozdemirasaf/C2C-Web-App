                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="../netting/adminislem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Üye Tip <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="kullanici_tc" value="<?php echo $kullanicicek['kullanici_banka'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="kullanici_tc" value="<?php echo $kullanicicek['kullanici_iban'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            <div id="kurumsal">
                    ...
                    ?> -->
                            ...
                            <div class="form-group">
                                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <button type="submit" name="magazaonaykaydet" class="btn btn-success">Başvuru Onay</button>
                                    <a onclick="return confirm('Mağza Başvurusunu Reddetmek İstiyormusunuz ?')" class="btn btn-danger" href="../netting/adminislem.php?magazaOnay=iptal&kullaniciID=<?php echo $kullanicicek['kullanici_id']; ?>">Başvuru İptal</a>
                                </div>
                            </div>
