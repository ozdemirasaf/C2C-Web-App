                        ...
                        <div class="personal-info inner-page-padding">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    siparis.siparis_id=siparis_detay.siparis_id INNER JOIN kullanici ON siparis_detay.kullanici_id=kullanici.kullanici_id INNER JOIN urun 
                                    ON urun.urun_id=siparis_detay.urun_id
                                    WHERE siparis.kullanici_idsatici=:kullanici_idsatici AND siparis_detay.siparisdetay_siparisdetay_onay=:onay or siparis_detay.siparisdetay_siparisdetay_onay=:onaylanan order by siparis_zaman DESC");
